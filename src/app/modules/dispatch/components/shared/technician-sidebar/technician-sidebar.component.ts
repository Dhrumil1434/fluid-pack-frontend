    ...
    >
      <div class="p-6 border-b border-neutral-300">
        <div class="flex items-center space-x-3">
          <div
            class="w-10 h-10 rounded-xl flex items-center justify-center shadow-lg overflow-hidden bg-bg-soft"
          >
            <img
              src="assets/logo/avtaar.png"
              alt="Logo"
      ...
      >
        ...
        >
          <div
            class="w-10 h-10 rounded-full flex items-center justify-center shadow-lg overflow-hidden bg-bg-soft"
          >
            <img
              src="assets/logo/avtaar.png"
              alt="Avatar"
